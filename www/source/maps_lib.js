...
$.extend(MapsLib, {
    ...
    mapOverlayLayers:   [],
    mapOverlayOrder:    [],
    map_centroid:       new google.maps.LatLng(48.116202, -1.662534), // center on SF if all else fails Modif pour Rennes
    defaultZoom:        9,
    ...
    blueDotImage:       '//maps.google.com/intl/en_us/mapfiles/ms/micons/green-dot.png',
    ...
    queueInfobox:       false,
    nearbyPinInfobox:   MapsLib.nearbyPinInfobox || "Votre Position.",
    ...
    initDefaults: function() {
        ...
        {
            // default to US
            MapsLib.searchPage.addressAutocomplete.country = "fr";
        }
    },
    ...
    searchHtml: function() {
        ...
        if (settings.addressShow)
        {
            ...
            html.push("<input class='input-block-level' data-clear-btn='true' id='search_address' placeholder='Lieu ou positionner la carte' type='text' />");
        }
        if (settings.distanceFilter.entries.length > 0)
        {
